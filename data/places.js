...
export const places = [
  ...
  // Día 3 - Noto / Vendicari / Marzamemi (desde Siracusa)
  { id: "noto", name: "Noto", address: "96017 Noto, Siracusa, Italia", lat: 36.892443, lng: 15.065194, tipo: "Pueblo", prioridad: "Imprescindible", zona: "Sureste", dia: 3 },
  { id: "vendicari", name: "Riserva di Vendicari", lat: 36.798643, lng: 15.092975, tipo: "Naturaleza", prioridad: "Imprescindible", zona: "Sureste", dia: 3, horario: "7:00 – 19:30 verano", precio: "3 €", nota: "Reserva con varias playas y la tonnara. Calamosche está DENTRO." },
  { id: "calamosche", name: "Spiaggia di Calamosche (en Vendicari)", lat: 36.824427, lng: 15.105836, tipo: "Playa", prioridad: "Secundario", zona: "Sureste", dia: 3, nota: "Cala más fotogénica del parque. ~25 min andando desde el parking." },
  { id: "marzamemi", name: "Marzamemi", lat: 36.738900, lng: 15.114200, tipo: "Pueblo", prioridad: "Secundario", zona: "Sureste", dia: 3, nota: "Cena temprana y paseo. Cierre ideal del día." },

  // ===== RAGUSA / MODICA (día 4 → Agrigento) + CASALE (día 5) =====
  { id: "ragusa-ibla", name: "Ragusa Ibla", address: "97100 Ragusa, Italia", lat: 36.926293, lng: 14.744105, tipo: "Pueblo", prioridad: "Imprescindible", zona: "Sureste", dia: 4 },
  { id: "duomo-san-giorgio-ragusa", name: "Duomo di San Giorgio (Ragusa)", lat: 36.926671, lng: 14.742620, tipo: "Ciudad", prioridad: "Imprescindible", zona: "Sureste", dia: 4, horario: "10:00 – 12:30 · 16:00 – 18:30", precio: "Gratis" },
  { id: "panorama-ragusa", name: "Panorama Città Ragusa", lat: 36.919588, lng: 14.758816, tipo: "Mirador", prioridad: "Secundario", zona: "Sureste", dia: 4 },
  { id: "modica", name: "Modica", address: "97015 Modica, Ragusa, Italia", lat: 36.858972, lng: 14.760840, tipo: "Pueblo", prioridad: "Imprescindible", zona: "Sureste", dia: 4 },
  { id: "duomo-san-pietro-modica", name: "Duomo di San Pietro (Modica)", lat: 36.860679, lng: 14.760751, tipo: "Ciudad", prioridad: "Secundario", zona: "Sureste", dia: 4, horario: "9:00 – 12:30 · 16:00 – 19:00", precio: "Gratis" },
  { id: "catedral-san-jorge-modica", name: "Duomo di San Giorgio (Modica)", lat: 36.863934, lng: 14.761457, tipo: "Ciudad", prioridad: "Secundario", zona: "Sureste", dia: 4, horario: "9:00 – 12:30 · 16:00 – 19:30", precio: "Gratis" },
  { id: "villa-romana-casale", name: "Villa Romana del Casale", lat: 37.364724, lng: 14.334552, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Interior", dia: 5, horario: "9:00 – 19:00 · último acceso 18:00", precio: "17 € hasta 30 junio 2026", nota: "UNESCO. Mosaicos romanos sin igual. Loop desde Agrigento por la mañana." },
  ...
  // ===== AGRIGENTO (día 5) / TRAPANI ROUTE (día 6) =====
  { id: "valle-templos", name: "Valle de los Templos", lat: 37.292366, lng: 13.593701, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Sur", dia: 5, horario: "8:30 – 20:00 · visitas nocturnas algunos días verano", precio: "13.50 €", nota: "Hacerlo al atardecer (17:00-20:00): luz dorada y menos calor que por la mañana." },
  { id: "scala-turchi-ingresso", name: "Ingresso Scala dei Turchi", lat: 37.289940, lng: 13.473827, tipo: "Mirador", prioridad: "Imprescindible", zona: "Sur", dia: 6, horario: "10:00 – 19:00 · acceso con pass por franja", precio: "5-6 € según pass", nota: "Acceso reabierto de forma controlada y limitada. Reservar pass; no salirse del recorrido autorizado." },
  { id: "scala-turchi-belvedere", name: "Belvedere Scala dei Turchi", lat: 37.293285, lng: 13.470120, tipo: "Mirador", prioridad: "Imprescindible", zona: "Sur", dia: 6, nota: "Plan visual de respaldo si no hay pass para pisar el tramo autorizado." },
  { id: "selinunte", name: "Parque Arqueológico de Selinunte", lat: 37.583600, lng: 12.825900, tipo: "Arqueología", prioridad: "Revisar", zona: "Sur", horario: "9:00 – 19:00", precio: "6 € · cochecillo eléctrico +6 €", nota: "DESCARTADO del plan: no encaja con Palazzo Adriano + Scala + Trapani en un día. El viaje conserva Neapolis, Templos, Casale y Segesta." },
  ...
  { id: "zingaro", name: "Riserva dello Zingaro", lat: 38.122364, lng: 12.785063, tipo: "Naturaleza", prioridad: "Imprescindible", zona: "Noroeste", dia: 8, horario: "7:00 – 19:30 verano", precio: "5 €", nota: "Entrar muy temprano. Elegir 1-2 calas. Llevar agua, gorra, escarpines." },
  ...
  { id: "castle-venus", name: "Castello di Venere (Erice)", lat: 38.035323, lng: 12.591744, tipo: "Ciudad", prioridad: "Imprescindible", zona: "Noroeste", dia: 9, horario: "10:00 – 19:00 verano", precio: "4 €" },
  { id: "erice-panorama", name: "Erice Panorama", lat: 38.041660, lng: 12.587536, tipo: "Mirador", prioridad: "Secundario", zona: "Noroeste", dia: 9 },
  { id: "trapani-erice-cableway", name: "Funivia Trapani-Erice", lat: 38.036508, lng: 12.582513, tipo: "Transporte", prioridad: "Secundario", zona: "Noroeste", dia: 9, horario: "9:00 – 21:00 verano (consultar día)", precio: "5.50 € ida · 9.50 € ida y vuelta" },
  { id: "mozia", name: "Mozia / Isola di San Pantaleo", lat: 37.869400, lng: 12.470800, tipo: "Arqueología", prioridad: "Secundario", zona: "Noroeste", dia: 9, horario: "9:30 – 18:30", precio: "9 € (incluye lancha + museo)", nota: "Isla fenicia a 5 min en lancha. Auriga de Mozia + ruinas + salinas alrededor." },
  { id: "saline-marsala", name: "Saline di Marsala (Ettore e Infersa)", lat: 37.874200, lng: 12.463100, tipo: "Mirador", prioridad: "Secundario", zona: "Noroeste", dia: 9, horario: "9:00 – atardecer", precio: "Visita molino 5 € · acceso paseo gratis", nota: "Atardecer con molinos. MEJOR que las salinas de Trapani." },

  // ===== SEGESTA / PALERMO / MONREALE (días 10-11) =====
  { id: "segesta-parque", name: "Parque Arqueológico de Segesta", lat: 37.941769, lng: 12.835728, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Noroeste", dia: 10, horario: "9:00 – 19:30 verano · último acceso 18:30", precio: "6 € · shuttle interno 1.50 €" },
  { id: "segesta-templo", name: "Templo de Segesta", lat: 37.941424, lng: 12.832379, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Noroeste", dia: 10, nota: "Incluido en la entrada del parque arqueológico." },
  { id: "segesta-teatro", name: "Teatro de Segesta", lat: 37.941099, lng: 12.843865, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Noroeste", dia: 10, nota: "Incluido en la entrada del parque. Shuttle interno si no apetece subir andando." },
  { id: "monreale", name: "Monreale (Catedral + Claustro)", address: "90046 Monreale, Palermo, Italia", lat: 38.080759, lng: 13.288090, tipo: "Ciudad", prioridad: "Imprescindible", zona: "Palermo", dia: 10, horario: "Catedral 8:30–12:45 · 14:30–17:00", precio: "Catedral gratis · Claustro 6 € · Terrazas 5 €", nota: "Cierra al mediodía. Llegar antes de las 12 o pasadas las 15." },
  ...
  { id: "cappella-palatina", name: "Cappella Palatina", lat: 38.111500, lng: 13.353100, tipo: "Ciudad", prioridad: "Imprescindible", zona: "Palermo", dia: 11, horario: "Lun-Sáb 8:15–17:40 · Dom 8:15–13:00", precio: "19 € (incluye Palazzo dei Normanni)", nota: "OBLIGATORIA. Mosaicos normando-bizantinos del s. XII. Reservar online." },
  { id: "catacombe-cappuccini", name: "Catacombe dei Cappuccini", lat: 38.116300, lng: 13.343300, tipo: "Ciudad", prioridad: "Secundario", zona: "Palermo", dia: 11, horario: "9:00 – 13:00 · 15:00 – 18:00", precio: "5 €", nota: "8.000 cuerpos momificados en las criptas. Visita impactante, no para todos." },
  ...
  { id: "catedral-cefalu", name: "Catedral de Cefalù", lat: 38.040090, lng: 14.023172, tipo: "Ciudad", prioridad: "Imprescindible", zona: "Norte", dia: 12, horario: "8:00 – 13:00 · 14:00 – 17:00", precio: "Catedral gratis · Claustro + torre 6 €" },
  ...
  { id: "tindari", name: "Santuario di Tindari + Laguna Marinello", lat: 38.139500, lng: 15.038600, tipo: "Mirador", prioridad: "Imprescindible", zona: "Norte", dia: 12, horario: "Santuario 6:45–12:30 · 14:30–18:30", precio: "Santuario gratis · Yacimiento arqueológico 4 €", nota: "Parada IMPRESCINDIBLE en ruta Cefalù → Giardini Naxos. Santuario en acantilado + laguna en forma de cara." },
  { id: "taormina-teatro", name: "Teatro Antico de Taormina", lat: 37.852318, lng: 15.292134, tipo: "Arqueología", prioridad: "Imprescindible", zona: "Este", dia: 13, horario: "9:00 – 19:00 · puede cerrar antes con eventos", precio: "14 €" },
  { id: "isola-bella", name: "Isola Bella", lat: 37.850548, lng: 15.300105, tipo: "Playa", prioridad: "Imprescindible", zona: "Este", dia: 13 },
  { id: "etna-norte", name: "Piano Provenzana (Etna Norte)", lat: 37.795600, lng: 15.038100, tipo: "Naturaleza", prioridad: "Imprescindible", zona: "Este", dia: 13, horario: "Carretera siempre · tours 4x4 9:00–16:00", precio: "Acceso libre · Tour 4x4 hasta cráteres ~70 €/persona", nota: "DESDE GIARDINI NAXOS, MEJOR QUE EL SUR: 50 min vs 1h20. Menos masificación." },
  { id: "etna-sur", name: "Rifugio Sapienza (Etna Sur)", lat: 37.702700, lng: 14.999400, tipo: "Naturaleza", prioridad: "Secundario", zona: "Este", dia: 13, horario: "Funivia 9:00 – 16:30 (consultar viento)", precio: "Funivia + bus + guía a 2900m ~70 € · solo funivia 30 €", nota: "Alternativa clásica. Más turística, más lejos desde Taormina." },
  { id: "alcantara", name: "Gole dell'Alcantara", lat: 37.880100, lng: 15.184300, tipo: "Naturaleza", prioridad: "Secundario", zona: "Este", dia: 13, horario: "7:00 – 19:00 verano", precio: "8 € parque botánico · 13 € con descenso al río", nota: "Gargantas de basalto. Plan B / refresco con calor. 25 min de Taormina." },
  ...
  { id: "palazzo-adriano", name: "Palazzo Adriano", lat: 37.681558, lng: 13.379220, tipo: "Pueblo", prioridad: "Imprescindible", zona: "Interior", dia: 5, horario: "Pueblo abierto siempre · Museo Cinema Paradiso (Piazza Umberto I) confirmar horario", precio: "Pueblo gratis · Museo Cinema Paradiso gratis", nota: "Localización principal de Cinema Paradiso. PERNOCTA del día 5 al 6: Piazza Umberto I al atardecer, cena local, mañana del día 6 con Museo Cinema Paradiso." },
